...
( 'Gentle Adjustment. Ice & Heat Therapy, Therapeutic Stretches, ', 'Happy Family Chirpractic',
 (SELECT patient_id from patient WHERE patient_firstname='Katelyn' AND patient_lastname='Tanton' AND patient_email='katie@email.com')
 );
...
('Upper Cervical Adjustment, Therapeutic Stretches, Ice & Heat Therapy, 12 Minute TENS Therapy', 'Alexander Chirpractic Center',
 (SELECT patient_id from patient WHERE patient_firstname='Emily' AND patient_lastname='Tanton' AND patient_email='emily@email.com')
 );
