...
9
        ...
        <main>
            <div id="container">
                <div clas="container-text">
                    ...
                    <p>
                      *Change your results page so that it only lists the book, chapter, and verse of the scripture (not the content), but make that text a link. Have the link lead to a "Scripture Details" page where the user can see the content for the selected 0p0op[scripture.jmn
   ...
   hy7mujd              echo "\"" . $row['scriptures_content'] . "\"";
                    echo '<br/>';
                    }
                }
